...
// Naming Practice
// var _myName = "vinod";
// var 1myName = "thapa"; // SyntaxError: Invalid or unexpected token
// var _1my__Name = "bahadur";
// var $myName = "thapa technical";
// var myNaem% = "thapa technical"; // SyntaxError: Unexpected token '%'
...
// var iAmUseless = null;
// console.log(iAmUseless); // null (string)
...
// let resultSec = 10 / 5
// console.log(resultSec); // 2
// console.log(isNaN(resultSec));  // false
...
// prefix = assign quick , postfix = assign after expression  
...
// console.log(message); // my name is vinod
// console.log(message.length); // 16
// console.log(message.padStart(20, "0")); // 0000my name is vinod
// console.log(message.padEnd(20, '0')); // my name is vinod0000
// console.log(message.length); // 16
...
// var myFriendNames = ["vinod","bahadur","thapa","thapatechnical","thapa", "vinod"];
// console.log(myFriendNames.indexOf("bahadur", 2)); // -1
 
// Array.prototype.lastIndexOf() 🙋‍♂️
// Returns the last (greatest) index of an element within the array equal 
// to an element, or -1 if none is found. It search the element last to first

// var myFriendNames = ["vinod","bahadur","thapa","thapatechnical","thapa", "harsh"];
// console.log(myFriendNames.lastIndexOf("thapa",4)); // 4
...
// const prices = [200,150,300,350,200,400,450,500,600];
// console.log(  prices.findIndex((currVal) => currVal > 199 )  ); // 0
...
// const prices = [200,250,300,350,400,450,500,600];
// // price < 400
...
//  sort method not accurate sort method return first capital latters first then small
// const months = [ 'aAb', 'Aa','zz', 'March', 'Jan', 'Feb', 'April' , 'Dec', 'Nov'];
// console.log(months.sort()); // ['Aa',  'April', 'Dec', 'Feb', 'Jan', 'March', 'Nov', 'aAb', 'zz' ]

//  for accurating sorting ( case senstive ) we caan use this 
// const months = ['aAbc', 'AaB', 'zz', 'March', 'Jan', 'Feb', 'April', 'Dec', 'Nov'];
// const caseInsensitiveSort = (a, b) => a.toLowerCase().localeCompare(b.toLowerCase());
// console.log(months.sort(caseInsensitiveSort)); // [ 'AaB',   'aAbc', 'April', 'Dec', 'Feb',   'Jan', 'March', 'Nov', 'zz']


// sort string desending order
// const months = ['aAb', 'Aa', 'zz', 'March', 'Jan', 'Feb', 'April', 'Dec', 'Nov'];
// const caseInsensitiveSortDescending = (a, b) => b.toLowerCase().localeCompare(a.toLowerCase());
// console.log(months.sort(caseInsensitiveSortDescending));

// if you want to run sort method in numbers 
// const array1 = [1, 30, 4, 21, 100000, 99];
// console.log(array1.sort( (a, b) => a - b )); // [ 1, 4, 21, 30, 99, 100000 ] //  asending order
// console.log(array1.sort( (a, b) => b - a )); // [ 100000, 99, 30, 21, 4, 1 ] // desending order
...
// console.log(myBioData.indexOf("t", 6)); // 9
// console.log(myBioData.lastIndexOf("t", 6)); // 5
...
// let repalceData = myBioData.replace('vinod','VINOD Replaces');
...
// let setmonth = curDate.setMonth(9); // 0-11 jan to dec
...
// Section3️⃣: Navigate through the DOM 
...
// Event propagation refers to the process by which events (such as user interactions with a web page, like clicks or keypresses) are handled and propagated through the DOM (Document Object Model) tree in a web browser. There are two phases of event propagation in the DOM: capturing phase and bubbling phase.

// Capturing Phase:
// During the capturing phase, the browser traverses from the root of the DOM tree down to the target element that triggered the event. This phase is less commonly used but can be relevant in certain scenarios.

// Target Phase:
// The event reaches the target element that originally triggered it.

// Bubbling Phase:
// After the event reaches the target, it starts bubbling up from the target element back to the root of the DOM tree. This is the more commonly used phase for handling events.
// In practical terms, when an event occurs on an element, it can be captured, processed at the target, and then bubble up through the ancestors of the target. Event propagation allows you to handle events at different levels of the DOM hierarchy.


// Controlling Event Propagation:
// You can use stopPropagation() method on the event object to stop the event from propagating further, either during the capturing phase or the bubbling phase. This can be useful when you want to prevent parent elements from receiving and handling the same event.
...
// // -----------------  GPT
// The event loop is a crucial concept in JavaScript that enables the asynchronous and non-blocking behavior of the language. It's fundamental to understanding how JavaScript handles tasks like handling user interactions, making network requests, and working with timers.

// The event loop can be visualized as a continuous loop that constantly checks the message queue and executes tasks in a single-threaded environment.

// Here's a simplified explanation of the event loop process:

// Call Stack:
// When your JavaScript code is executed, it goes through the call stack. The call stack is a data structure that keeps track of the currently executing function or block of code.

// Execution and Task Queue:
// When a function is called, it's added to the call stack. If a function contains asynchronous operations (like setTimeout, fetching data from a server, or handling user events), those operations are offloaded to the Web APIs provided by the browser (or the environment where JavaScript is running).

// Web APIs:
// Asynchronous operations are handled by Web APIs, which are external entities provided by the browser or the environment (e.g., the DOM API, XMLHttpRequest, setTimeout).

// Callback Queue (Message Queue):
// When an asynchronous operation is completed, a message is placed in the callback queue (also known as the message queue).

// Event Loop:
// The event loop continuously checks the call stack and the callback queue. If the call stack is empty, the event loop takes the first message from the callback queue and pushes it onto the call stack, executing the associated callback function.

// Repeat:
// This process repeats, allowing asynchronous operations to be handled without blocking the execution of the rest of the code.
...
// In this example, "Start" and "End" are logged before the "Timeout callback." Despite the setTimeout callback having a timeout of 0 milliseconds, it is still pushed to the callback queue, and the event loop ensures it is executed after the synchronous code has finished.

// Understanding the event loop is crucial for writing effective asynchronous JavaScript code and avoiding blocking operations that could freeze the user interface in web applications.
